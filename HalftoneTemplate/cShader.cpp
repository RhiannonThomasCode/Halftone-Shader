...
char *vShader[] = {	"shaders\\colour.vert",	"shaders\\material.vert","shaders\\circles.vert"// FLAG_MAPS_INTENSITYS 
};

char *fShader[] = {	"shaders\\colour.frag","shaders\\material.frag","shaders\\circles.frag"	// FLAG_MAPS_INTENSITY
};
